data = [
    ...
    },
    {
        ...
        "cost": 125,
        "quantity": 0,
        "overview": "For the Deciman in all of us",
    ...
    },
    {
        ...
        "description": "Once per day, you can use this can to make a ranged attack against a creature (if you're proficient with any crossbow or pistol, you're proficient with this can). On a hit, the target is blinded. The range for this weapon is 15/60.<br>Alternatively, you can spend one minute spraying a 15 ft. radius circle using this can. This area becomes difficult terrain for up to 8 hours.",
    ...
    },
    {
        ...
        "description": "Once per day, instead of rolling on an attack roll or ability check, you can flip a coin. A heads is a critical success; a tails is a critical fail.",
    ...
    },
    {
        ...
        "quantity": 1,
        "overview": `Strap in`,
        "description": `Once per day, you can move the straps on these versatile footwear to behind your heels, setting them to sport mode. For the next 10 minutes, you can move across water surfaces without sinking. However, you must be running to gain this benefit. If you stop or slow to a walking pace, you sink into the water as normal.`,
    ...
    },
    {
        ...
        Spells and potions that remove or negate negative poisons or effects will remove this effect.`,
...
Once used, this ability cannot be used again until a long rest.`,
    ...
    },
    {
        ...
        <br><br>If the surface the ink is written onto is targeted by anything that dispels magic, the ink of both colors disappears without revealing the message.`,
